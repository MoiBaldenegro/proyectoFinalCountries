            ...
            return(
                <div className={style.containerDetails}>
                    <div className={style.one}>
                        ...
                        <h2 className={style.countryName} >{cardDetailRender.name ? cardDetailRender.name : " - " } </h2> 
                       <NavLink to="/home" className={style.backButton}> Back </NavLink>
        
                    </div>
                    <div className={style.two}>
                        <h4 className={style.key}> {cardDetailRender.id ? cardDetailRender.id : " - "} </h4>
                    </div>
                    <div className={style.three}>
                       <h4 className={style.population}> Population: <br /> {cardDetailRender.population ? cardDetailRender.population : " - "} Habitantes.</h4>    
                    </div>
                    <div className={style.four}>
                        <h4 className={style.capital}> Capital: <br /> {cardDetailRender.capital ? cardDetailRender.capital : " - "} </h4>
